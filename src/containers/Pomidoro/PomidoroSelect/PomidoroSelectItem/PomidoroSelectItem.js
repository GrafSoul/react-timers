...
const PomidoroSelectItem = (props) => {
    return (
        <div>
            <h5 className={classes.PomidoroSelectTitle}>
            ...
            <div className={classes.PomidoroSelectItem}>
                <Button
                    ...
                    onClick={
                        props.setMinTime > 1
                            ? props
                                  .timeDecrement(props.name)
                                  .bind(null, props.name)
                            : null
                    }
                >
                    <i className="fas fa-minus-square" />
                </Button>
                <Badge color="info" className={classes.PomidoroNumber}>
                    {props.setMinTime}
                </Badge>
