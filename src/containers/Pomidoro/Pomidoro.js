...
const mapDispatchToProps = (dispatch) => {
    return {
        timeIncrement: (section) =>
            dispatch(actionCreators.pomidoroIncrement(section)),
        timeDecrement: (section) =>
            dispatch(actionCreators.pomidoroDecrement(section)),

        setWorkSec: (workSec) =>
            dispatch(actionCreators.pomidoroSetWorkSec(workSec)),
        setWorkMin: (workMin) =>
            dispatch(actionCreators.pomidoroSetWorkMin(workMin)),

        setRelaxSec: (relaxSec) =>
            dispatch(actionCreators.pomidoroSetRelaxSec(relaxSec)),
        setRelaxMin: (relaxMin) =>
            dispatch(actionCreators.pomidoroSetRelaxMin(relaxMin)),
        ...
        selectInfo: (text, color) =>
            dispatch(actionCreators.pomidoroSetInfo(text, color)),
    };
};
