...
const mapDispatchToProps = (dispatch) => {
    return {
        ...
        setCurrentTime: (hour, min, sec) =>
            dispatch(actionCreators.alarmCurrentTime(hour, min, sec)),

        toggleModal: () => dispatch(actionCreators.alarmToggleModal()),
        getAlarms: (alarms) =>
            dispatch(actionCreators.alarmGetLocalAlarms(alarms)),
        ...
        editSignal: (id, hour, min) =>
            dispatch(actionCreators.alarmEditSignal(id, hour, min)),
        editIncrement: (set) =>
            dispatch(actionCreators.alarmEditIncrement(set)),
        editDecrement: (set) =>
            dispatch(actionCreators.alarmEditDecrement(set)),
